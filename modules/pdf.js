...
export function buildContractDocHtml(contract) {
  ...
  const sections = [
    ...
    contractSection(4, 'EXCLUSIONS', '<p>Unless specifically listed in the Scope of Work, the following are excluded: permits, engineering, hidden or unforeseen conditions, repairs due to code violations, structural work, painting, low voltage/security, appliances, or any work not expressly stated above.</p>'),
    ...
    contractSection(8, 'START & COMPLETION', '<div class="date-lines"><div class="fill-row"><span>Estimated Start Date</span><i></i></div><div class="fill-row"><span>Estimated Completion Date</span><i></i></div></div><p>Dates are estimates and may be adjusted due to weather, material availability, or unforeseen circumstances.</p>'),
  ...
  <style>
    *{box-sizing:border-box}html,body{margin:0;padding:0;background:#eee9e0;color:#181410;font-family:Arial,Helvetica,sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact}
    ...
    .agreement-body{padding:0 34px 26px}.agreement-section{margin-top:15px;break-inside:avoid;page-break-inside:avoid}.agreement-section h2{margin:0;padding:7px 10px;background:#181410;color:#caa05a;font-size:11px;letter-spacing:.07em}.agreement-section p,.agreement-section li,.party-block{font-size:10pt;line-height:1.48}.agreement-section p{margin:9px 2px}.agreement-section ul{margin:8px 0;padding-left:23px}.party-block{padding:10px;border:1px solid #ddd2c2;border-top:0}.field-grid{display:grid;grid-template-columns:120px 1fr;border:1px solid #ddd2c2;border-top:0}.field-grid span,.field-grid strong{padding:7px 10px;border-bottom:1px solid #eee6da;font-size:10pt}.field-grid span{font-weight:700;background:#faf7f1}.spouse-block{padding:10px;border:1px solid #ddd2c2;border-top:0;font-size:9pt}.fill-row{display:flex;align-items:flex-end;gap:9px;margin-top:12px;font-size:10pt}.fill-row span{white-space:nowrap}.fill-row i{display:block;flex:1;height:16px;border-bottom:1px solid #4d4438}.scope-box{min-height:110px;padding:12px;border:1px solid #d8c9b2;line-height:1.55;white-space:normal;font-size:10pt}.price-box{display:flex;justify-content:space-between;align-items:center;margin:10px 0;padding:12px 15px;background:#f7ead2;border:2px solid #caa05a}.price-box span{font-size:10px;font-weight:800;letter-spacing:.08em}.price-box strong{font-size:18px}
    ...
    @media print{@page{size:letter;margin:.45in}.bar{display:none}body{background:#fff}.sheet{width:auto;max-width:none;margin:0;box-shadow:none}.masthead{margin:-.45in -.45in 0}.agreement-section{orphans:3;widows:3}.agreement-section h2{break-after:avoid;page-break-after:avoid}.verse{margin:0 -.45in -.45in}}
